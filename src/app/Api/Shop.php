  ...
  public function getRules() {
    ...
    return $this->rules([
      ...
      'create' => [
        ...
        'shop_name' => 'shop_name|string|true||行用卡名称',
        'shop_code' => 'shop_code|string|false||行用卡编码',
        'phone' => 'phone|string|false||行用卡电话',
        'open_time' => 'open_time|string|false||营业时间',
        'thumbnail' => 'thumbnail|string|false||行用卡logo',
        'words' => 'words|string|false||一句话介绍',
        'ext_1' => 'ext_1|int|false||最小额度',
        'ext_2' => 'ext_2|int|false||最大额度',
        'brief' => 'brief|string|false||行用卡简介',
        'account_date' => 'account_date|int|false||结算周期',
        'image_text' => 'image_text|string|false||行用卡照片',
        'carousel' => 'carousel|string|false||行用卡轮播图',
        ...
        'status' => 'status|int|false|1|行用卡状态：1.有效，2.停用'
      ...
      'updateShop' => [
        ...
        'shop_name' => 'shop_name|string|false||行用卡名称',
        'shop_code' => 'shop_code|string|false||行用卡编码',
        'phone' => 'phone|string|false||行用卡电话',
        'ext_1' => 'ext_1|int|false||最小额度',
        'ext_2' => 'ext_2|int|false||最大额度',
